            ...
            <el-table :data="forumData" height="250">
                ...
                <el-table-column label="身份">
                    <template slot-scope="scope">
                        <span v-if="scope.row.zhixunshiId">
                            咨询师
                        </span>
                ...
                <el-table-column property="caozuo" label="操作">
                    <template slot-scope="scope">
                        <el-button type="info"                          @click="seeForumContent(scope.row.forumContent)">回帖详情</el-button>
                            <el-button v-if="true &&( false|| (sessionTable == 'zhixunshi' && scope.row.zhixunshiId ==userId)
                ...
                <el-row class="ad" :style="{justifyContent:contents.btnAdAllBoxPosition=='1'?'flex-start':contents.btnAdAllBoxPosition=='2'?'center':'flex-end'}">
                    <el-form-item>
                        ...
                        <a style="text-decoration:none" class="el-button el-button--success"
                           ...
                           href="http://localhost:8080/daxueshengxinlijiankangpingce/upload/forumMuBan.xls"
                        >批量导入论坛数据模板</a>
                        &nbsp;
                        <el-upload
                                v-if="isAuth('forum','导入导出')"
                ...
                _this.$http({
                    ...
                    if (data && data.code === 0) {
                        ...
                        data.data.list.forEach(el=>{
                            ...
                            forum.zhixunshiId = el.zhixunshiId;//---
                            forum.zhixunshiName = el.zhixunshiName;
                            forum.zhixunshiPhoto = el.zhixunshiPhoto;
                            forum.zhixunshiIdNumber = el.zhixunshiIdNumber;
                            forum.zhixunshiPhone = el.zhixunshiPhone;
                            forum.zhixunshiEmail = el.zhixunshiEmail;
                            forum.zhixunshiCongye = el.zhixunshiCongye;
                            forum.zhixunshiShanchang = el.zhixunshiShanchang;
                            forum.zhixunshiContent = el.zhixunshiContent;
                            forum.zhixunshiDelete = el.zhixunshiDelete;
                            forum.createTime = el.createTime;
