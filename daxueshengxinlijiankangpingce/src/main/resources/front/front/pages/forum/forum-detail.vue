<template>
	<view>
        ...
        <view class="username">
			<text v-if="forum.zhixunshiId != null">
				 发布人：{{forum.zhixunshiName}}（咨询师）
			</text>
			...
			<view class="uni-article__comment-box" v-for="comment in commentData" :key="comment.id" >
				<view class="article-meta">
					<view class="article-header-image">
                        <image v-if="comment.zhixunshiId != null" class="image" :src="baseUrl+comment.zhixunshiPhoto" mode="widthFix"></image>
					...
					<view class="article-header-content">
						<view class="article-header-title">
							<text v-if="comment.zhixunshiId != null">{{comment.zhixunshiName}}</text>
